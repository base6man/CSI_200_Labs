 ...
 * @brief takes text from an input file, then returns the sorted unique words along with their number of appearances and the number of appearances of each letter.
 * @version 0.1
 * @date 2023-10-10
 * 
